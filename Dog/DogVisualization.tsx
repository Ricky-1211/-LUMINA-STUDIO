...
function DogVisualization({ onEnterEditor }: DogVisualizationProps) {
    return (
        <main>
            <button
                type="button"
                className="enter-editor"
                onClick={onEnterEditor}
                aria-label="Open code editor"
            >
                <span>Open Code Editor</span>
                <span className="enter-editor__icon">→</span>
            </button>
...
export default DogVisualization;
